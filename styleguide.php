    ...
    <section id="main-content">
      <div class="inner">
        ...
        <p><img alt="Placeholder Image and Some Alt Text" src="http://placehold.it/800x250" title="A title element for this placeholder image."></p>
        ...
        <fieldset>
          ...
          <form>
            ...
            <p><input class="button-s button-pri" type="reset" value="Clear" /> <input class="button-s button-pri" type="submit" value="Submit" />
            </p>
          ...
          <a href="#" class="button-s button-pri">Small Primary Button</a><br />
          <a href="#" class="button-m button-pri">Medium Primary Button</a><br />
          <a href="#" class="button-l button-pri">Large Primary Button</a><br />

          <h2>Secondary Buttons</h2>
          <a href="#" class="button-s button-sec">Small Secondary Button</a><br />
          <a href="#" class="button-m button-sec">Medium Secondary Button</a><br />
          <a href="#" class="button-l button-sec">Large Secondary Button</a><br />

          <h2>Tertiary Buttons</h2>
          <a href="#" class="button-s button-tri">Small Secondary Button</a><br />
          <a href="#" class="button-m button-tri">Medium Secondary Button</a><br />
          <a href="#" class="button-l button-tri">Large Secondary Button</a><br />
